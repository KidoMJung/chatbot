$(document).ready(function () {
    ...
    var out = function(outtext) {
        ...
        // 2.3)create a DOM text with document.createTextNode that contains the argument of what goes in the function out and store it to varriable named paraTxt
    
        
        // 2.4) Create a DOM to append the variable paraText to variable newPara so that it is displayed on the screen
        newPara.appendChild(paraText);

        //2.5) Create a DOM to append the variable newPara to the  div with id "robotMessages"
